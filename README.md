...
- `assets/css/style.css` — shared responsive presentation
...
`docs/project-framework.md` records the project’s static-site and editorial conventions. Before a release, run:
